Module zonide
    ...
    Public Function zBotNameCheck()
        If Form1.zBCmdStart = False Then Exit Function
        Dim zSs As String
        zSs = Form1.txtBotCmdName.Text
        zSs = zAlphaNumFilter(zSs)
        If zSs = vbNullString Then
            Form1.txtBotCmdName.Text = "bot0"
            zSs = "bot0"
        End If
        Dim zLastChar As String
        zLastChar = Mid(zSs, Len(zSs), 1)
        If zLastChar <> "0" Then
            zSs = zSs & "0"
            Form1.txtBotCmdName.Text = zSs
        End If
    End Function
