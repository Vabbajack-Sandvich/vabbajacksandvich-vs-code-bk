rem C:\Program Files (x86)\Steam\steamapps\common\ARK\ShooterGame\Saved
rem D:\zonide\gamebackups\ark\settings-saves
...
set basep=D:\zonide\gamebackups\ark\settings-saves\
...
xcopy "C:\progra~2\Steam\steamapps\common\ARK\ShooterGame\Saved\" %finalpath4% /f /h /r /y /j /d /e
