rem C:\Program Files (x86)\Steam\steamapps\common\No Man's Sky\Binaries\SETTINGS

rem D:\zonide\gaming-stuff\nms-settings

rem chdir /D c:

rem cd "C:\Progra~2\steam\steamapps\common\NOMAN'~1\Binaries\"

rem C:\Program Files (x86)\Steam\steamapps\common\Rust\cfg
rem D:\zonide\gaming-stuff\rust\settings
...
set basep=D:\zonide\gaming-stuff\nms-settings\
...
xcopy "C:\Progra~2\steam\steamapps\common\NOMAN'~1\Binaries\settings\" %finalpath4% /f /h /r /y /j /d /e
