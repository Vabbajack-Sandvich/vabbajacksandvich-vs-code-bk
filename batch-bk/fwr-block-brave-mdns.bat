rem C:\Program Files\BraveSoftware\Brave-Browser\ApplicationC:\Program Files\BraveSoftware\Brave-Browser\Application
...
for /R "C:\Program Files\BraveSoftware\Brave-Browser\Application\" %%G in (*.exe) DO (
...
for /R "C:\Program Files\BraveSoftware\Brave-Browser\Application\" %%G in (*.dll) DO (
