...
rem D:\SteamLibrary\steamapps\common\Teamfo~1\tf\custom\mycustom\resource\ui

rem for d drive
rem base D:\SteamLibrary\steamapps\common\Team Fortress 2

robocopy "D:\SteamLibrary\steamapps\common\Team fortress 2\tf\custom\mycustom\resource\ui" "D:\zonide\gaming-stuff\tf2\scoreboard-swapout-batchfile\tf2-from-temp" "scoreboard.res" /MOV
rem pause
robocopy "D:\zonide\gaming-stuff\tf2\scoreboard-swapout-batchfile\tf2-to-temp" "D:\SteamLibrary\steamapps\common\Team fortress 2\tf\custom\mycustom\resource\ui" "scoreboard.res" /MOV
rem pause
