rem C:\Program Files (x86)\Steam\steamapps\common\ARK
rem allow steam on d drive
for /R "C:\Program Files (x86)\Steam\steamapps\common\ARK\" %%G in (*.exe) DO (
...
for /R "C:\Program Files (x86)\Steam\steamapps\common\ARK\" %%G in (*.dll) DO (
