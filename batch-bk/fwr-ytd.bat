rem D:\zonide\CODE\YoutubeDownloader.win-x64
for /R "D:\zonide\CODE\YoutubeDownloader.win-x64\" %%G in (*.exe) DO (
...
for /R "D:\zonide\CODE\YoutubeDownloader.win-x64\" %%G in (*.dll) DO (
