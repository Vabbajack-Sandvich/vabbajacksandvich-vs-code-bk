rem C:\Program Files (x86)\Steam\steamapps\common\Palworld

for /R "C:\Program Files (x86)\Steam\steamapps\common\Palworld\" %%G in (*.exe) DO (
...
for /R "C:\Program Files (x86)\Steam\steamapps\common\Palworld\" %%G in (*.dll) DO (
